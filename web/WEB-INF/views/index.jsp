...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="#" data-index="0">用户管理</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="J_menuItem" href="#">字典管理</a>
                        </li>
                        <li>
                            <a href="#" target="_blank">组织机构管理</a>
                        </li>
                    </ul>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2018 <a href="http://www.zi-han.net/" target="_blank">盛创软件工作室</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
